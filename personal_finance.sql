...
INSERT INTO `budgets` (`id`, `user_id`, `category_id`, `amount`, `month_year`) VALUES
(1, 1, 13, 1000.00, '2025-06');
...
INSERT INTO `transactions` (`id`, `user_id`, `title`, `amount`, `type`, `date`, `category_id`) VALUES
(1, 1, 'test', 900.00, 'Expense', '2025-06-14', 4),
(2, 1, 'test', 200.00, 'Expense', '2025-06-14', 7),
(3, 1, 'fetwt', 98765.00, 'Income', '2025-06-26', 2);
...
(1, 'Syahrul', 'syahkill375@gmail.com', 'Bukalahi01');
